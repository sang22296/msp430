...
#define MASK_TINY_PRINTF (1U << 5)
#define MASK_USE_LOWER_REGION_PREFIX (1U << 6)
...
enum opt_code
{
  ...
  OPT_mOs = 1190,                            /* -mOs */
  OPT_masm_hex = 1191,                       /* -masm-hex */
  OPT_mcode_region_ = 1192,                  /* -mcode-region= */
  OPT_mcpu_ = 1193,                          /* -mcpu= */
  OPT_mdata_region_ = 1194,                  /* -mdata-region= */
  OPT_mdevices_csv_loc_ = 1195,              /* -mdevices-csv-loc= */
  OPT_mdisable_device_warnings = 1196,       /* -mdisable-device-warnings */
  OPT_mhwmult_ = 1197,                       /* -mhwmult= */
  OPT_minrt = 1198,                          /* -minrt */
  OPT_mlarge = 1199,                         /* -mlarge */
  OPT_mmcu_ = 1200,                          /* -mmcu= */
  OPT_mno_gc = 1201,                         /* -mno-gc */
  OPT_mrelax = 1202,                         /* -mrelax */
  OPT_msilicon_errata_warn_ = 1203,          /* -msilicon-errata-warn= */
  OPT_msilicon_errata_ = 1204,               /* -msilicon-errata= */
  OPT_msim = 1205,                           /* -msim */
  OPT_msmall = 1206,                         /* -msmall */
  OPT_mtiny_printf = 1207,                   /* -mtiny-printf */
  OPT_muse_lower_region_prefix = 1208,       /* -muse-lower-region-prefix */
  OPT_mwarn_mcu = 1209,                      /* -mwarn-mcu */
  OPT_n = 1210,                              /* -n */
  OPT_no_canonical_prefixes = 1211,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1212,              /* -no-integrated-cpp */
  OPT_no_pie = 1213,                         /* -no-pie */
  OPT_nocpp = 1214,                          /* -nocpp */
  OPT_nodefaultlibs = 1215,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1216,                   /* -nostartfiles */
  OPT_nostdinc = 1217,                       /* -nostdinc */
  OPT_nostdinc__ = 1218,                     /* -nostdinc++ */
  OPT_nostdlib = 1219,                       /* -nostdlib */
  OPT_o = 1220,                              /* -o */
  OPT_p = 1221,                              /* -p */
  OPT_pass_exit_codes = 1222,                /* -pass-exit-codes */
  /* OPT_pedantic = 1223, */                 /* -pedantic */
  OPT_pedantic_errors = 1224,                /* -pedantic-errors */
  OPT_pg = 1225,                             /* -pg */
  OPT_pie = 1226,                            /* -pie */
  OPT_pipe = 1227,                           /* -pipe */
  OPT_print_file_name_ = 1228,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1229,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1230,          /* -print-multi-directory */
  OPT_print_multi_lib = 1231,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1232,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1233,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1234,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1235,               /* -print-prog-name= */
  OPT_print_search_dirs = 1236,              /* -print-search-dirs */
  OPT_print_sysroot = 1237,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1238,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1239,                          /* -quiet */
  OPT_r = 1240,                              /* -r */
  OPT_remap = 1241,                          /* -remap */
  OPT_s = 1242,                              /* -s */
  ...
  OPT_static_pie = 1260,                     /* -static-pie */
  ...
  OPT_std_c__2a = 1268,                      /* -std=c++2a */
  OPT_std_c__98 = 1269,                      /* -std=c++98 */
  OPT_std_c11 = 1270,                        /* -std=c11 */
  OPT_std_c17 = 1271,                        /* -std=c17 */
  /* OPT_std_c18 = 1272, */                  /* -std=c18 */
  ...
  OPT_std_f2018 = 1281,                      /* -std=f2018 */
  OPT_std_f95 = 1282,                        /* -std=f95 */
  OPT_std_gnu = 1283,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1284, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1285, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1286,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1287,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1288,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1289, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1290, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1291,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1292,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1293,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1294,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1295, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1296, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1297, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1298,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1299,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1300, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1301, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1302,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1303, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1304, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1305, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1306, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1307, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1308,                     /* -std=legacy */
  OPT_symbolic = 1309,                       /* -symbolic */
  OPT_t = 1310,                              /* -t */
  OPT_time = 1311,                           /* -time */
  OPT_time_ = 1312,                          /* -time= */
  OPT_traditional = 1313,                    /* -traditional */
  OPT_traditional_cpp = 1314,                /* -traditional-cpp */
  OPT_trigraphs = 1315,                      /* -trigraphs */
  OPT_u = 1316,                              /* -u */
  OPT_undef = 1317,                          /* -undef */
  OPT_v = 1318,                              /* -v */
  OPT_version = 1319,                        /* -version */
  OPT_w = 1320,                              /* -w */
  OPT_wrapper = 1321,                        /* -wrapper */
  OPT_x = 1322,                              /* -x */
  OPT_z = 1323,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
